...
SKIP_BUILDS=(
    "dashboards-plugin|release-coo-1.5-ocp-4.12|v0.4.3"
    "distributed-tracing-plugin|release-coo-1.5-ocp-4.12|v0.3.3"
    "logging-view-plugin|release-coo-1.5-ocp-4.12|v6.0.5"
    "distributed-tracing-plugin|release-coo-1.5-ocp-4.15|v0.4.3"
)
...
# release-coo-1.5-ocp-4.12
build_and_push dashboards-plugin release-coo-1.5-ocp-4.12 v0.4.3
build_and_push distributed-tracing-plugin release-coo-1.5-ocp-4.12 v0.3.3
build_and_push logging-view-plugin release-coo-1.5-ocp-4.12 v6.0.5

# release-coo-1.5-ocp-4.15
build_and_push distributed-tracing-plugin release-coo-1.5-ocp-4.15 v0.4.3
build_and_push logging-view-plugin release-coo-1.5-ocp-4.15 v6.1.6
build_and_push monitoring-plugin release-coo-1.5-ocp-4.15 v0.4.5

# release-coo-1.5-ocp-4.19
build_and_push distributed-tracing-plugin release-coo-1.5-ocp-4.19 v1.0.3
build_and_push troubleshooting-panel-plugin release-coo-1.5-ocp-4.19 v0.4.5
build_and_push monitoring-plugin release-coo-1.5-ocp-4.19 v0.5.4

# release-coo-1.5-ocp-4.22
build_and_push distributed-tracing-plugin release-coo-1.5-ocp-4.22 v1.1.0
build_and_push troubleshooting-panel-plugin release-coo-1.5-ocp-4.22 v1.0.0
build_and_push monitoring-plugin release-coo-1.5-ocp-4.22 v1.0.0
build_and_push logging-view-plugin release-coo-1.5-ocp-4.22 v6.2.1
...
get_image_name() {
    ...
    case "$repo" in
        dashboards-plugin)
            echo "console-dashboards-plugin"
            ;;
        distributed-tracing-plugin)
