...
| Branch | Repo (local directory) | Official Repository / Image name | Tag |
|--------|----------------------|----------------------------------|-----|
| release-coo-ocp-4.12 | distributed-tracing-plugin | distributed-tracing-console-plugin | v0.3.3 |
| release-coo-ocp-4.12 | logging-view-plugin | logging-view-plugin | v6.0.5 |
| release-coo-ocp-4.15 | distributed-tracing-plugin | distributed-tracing-console-plugin | v0.4.3 |
...
| release-coo-ocp-4.19 | distributed-tracing-plugin | distributed-tracing-console-plugin | v1.0.3 |
| release-coo-ocp-4.19 | troubleshooting-panel-plugin | troubleshooting-panel-console-plugin | v0.4.5 |
| release-coo-ocp-4.19 | monitoring-plugin | monitoring-console-plugin | v0.5.4 |
| release-coo-ocp-4.22 | distributed-tracing-plugin | distributed-tracing-console-plugin | v1.1.0 |
| release-coo-ocp-4.22 | troubleshooting-panel-plugin | troubleshooting-panel-console-plugin | v1.0.0 |
...
**Local directory names vs Official repository/image names:**
- `distributed-tracing-plugin` → `distributed-tracing-console-plugin` (Makefile hardcoded ✅)
- `troubleshooting-panel-plugin` → `troubleshooting-panel-console-plugin` (Makefile hardcoded ✅)
- `logging-view-plugin` → `logging-view-plugin` (same name ✅)
- `monitoring-plugin` → `monitoring-console-plugin` (requires PLUGIN_NAME override)
...
build_and_push distributed-tracing-plugin release-coo-ocp-4.12 v0.3.3
build_and_push logging-view-plugin release-coo-ocp-4.12 v6.0.5

# release-coo-ocp-4.15
build_and_push distributed-tracing-plugin release-coo-ocp-4.15 v0.4.3
...
build_and_push distributed-tracing-plugin release-coo-ocp-4.19 v1.0.3
build_and_push troubleshooting-panel-plugin release-coo-ocp-4.19 v0.4.5
build_and_push monitoring-plugin release-coo-ocp-4.19 v0.5.4

# release-coo-ocp-4.22
build_and_push distributed-tracing-plugin release-coo-ocp-4.22 v1.1.0
build_and_push troubleshooting-panel-plugin release-coo-ocp-4.22 v1.0.0
